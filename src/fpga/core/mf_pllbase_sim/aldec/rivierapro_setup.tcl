...
# ACDS 21.1 850 win32 2022.09.13.07:50:28
# ----------------------------------------
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/mf_pllbase.vo"
}
